...
| 🙏 렌더링 성공 기도하기 | `/pray.html` |
| 🔋 Ctrl+Z 충전소 | `/undo.html` |
| ☕ 커피콩 받기 | `/coffee.html` |
...
기어이 누르면 결과는 그때그때 다릅니다 — 대개 <b>응답 없음</b>이고, 가끔 <b>저장됨</b>입니다.<br>
잠시 뒤 버튼은 새 자리에서 다시 달아납니다.</td>
</tr>
<tr>
<td align="center">🙏</td>
<td><b>렌더링 성공 기도하기</b><br>
<b>두 손을 모으면</b> 렌더링이 시작되고 진행률이 오릅니다.<br>
99%에서 한참을 머무르다 — 갑자기 <b>에러</b>. 넷에 하나쯤은 기도가 통해 완료됩니다.</td>
</tr>
<tr>
<td align="center">🔋</td>
<td><b>Ctrl+Z 충전소</b><br>
손끝을 피해 <b>달아나는 Ctrl+Z</b>를 <b>검지 끝</b>으로 잡아 에너지를 채웁니다.<br>
그러다 갑자기 <b>「저번 버전이 더 좋은 것 같아요.」</b>가 도착하면 모아 둔 Ctrl+Z가 전부 소모됩니다.</td>
</tr>
<tr>
<td align="center">☕</td>
<td><b>커피콩 받기</b><br>
...
| 📄 `save.html` `pray.html` `undo.html` `coffee.html` | 작품 페이지 — 주소로 바로 접근 |
...
| 🙏 `pray.js` | 렌더링 성공 기도하기 (손 모으기 판정, 진행률, 결과 창) |
| 🔋 `undo.js` | Ctrl+Z 충전소 (떠다니는 키, 충전 칸, 클라이언트 메시지) |
